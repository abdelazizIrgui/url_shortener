...
// Selecting a country in the UI fills in its dial code automatically.
...
export const findCountryByName = (name) => COUNTRIES.find((c) => c.name === name) || null;

// Flag emoji from an ISO 3166-1 alpha-2 code, e.g. "MA" -> 🇲🇦
export const flagEmoji = (iso2) =>
  iso2
    ? String.fromCodePoint(...[...iso2.toUpperCase()].map((ch) => 127397 + ch.charCodeAt(0)))
    : "";
